 ...
 *
 * The tree has replaced the flat AccessPointState entirely: it composes the
 * states the pages show, drives the escalation, and is the only thing that
 * decides when bss management is switched on.
 */
